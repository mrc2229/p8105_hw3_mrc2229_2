...
day_activity_plot=accel_data %>%
  ...
  ggplot(aes(x=day_id,y=total_activity_for_day))+
  ...
  labs(
    ...
    x = "Day Number in the 5 Week Collection",
    y ="Total Activity"
  )
day_activity_plot
```